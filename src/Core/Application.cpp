      ...
      m_Scene("Main Scene")
{
    ...
    m_Scene.AddRigidBodyComponent(redTriangle, false, 1.0f, 0.3f, 0.5f); // Dynamic
    ...
    m_Scene.AddRigidBodyComponent(greenQuad, false, 1.0f, 0.3f, 0.3f); // Dynamic
    ...
    m_Scene.AddRigidBodyComponent(ground, true); // Static
